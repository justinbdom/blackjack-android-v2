...
public class GoogleSingInService {
  ...
  public static void setApplicationContext(Application applicationContext) {
    GoogleSingInService.applicationContext = applicationContext;
  }

  public static GoogleSingInService getInstance() {
  ...
  private static class InstanceHolder {
    ...
    private static final GoogleSingInService INSTANCE = new GoogleSingInService();
